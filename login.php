...
?>
    ...
    <div class="raw">
      ...
      <form class="form-signin col-lg-offset-4 col-lg-4" role="form" method="post" action="login.php?login">
...
?>
    <div class="row">
      ...
      <form class="form-signin col-lg-offset-4 col-lg-4" role="form"  method="post" action="login.php?create">
        ...
        <br/>
        <input  name="password" class=" form-control" placeholder="Mot de passe" required>
        <input name="confirmpassword" class="form-control" placeholder="Confirmation de Mot de passe" required>
        <br/>
